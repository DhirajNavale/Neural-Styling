...
components.html(
    ...
    <a class="btn btn-outline-secondary float-left" href="https://github.com/" target="_blank" role="button"><i class="fa fa-github" style="font-size:48px;" aria-hidden="true"></i>Click Here For Code</a>
    """,
    height=100,
)
